...
private final class ObservableSequenceSink<S: Sequence, O: ObserverType>: Sink<O> where S.Iterator.Element == O.E {
...
private final class ObservableSequence<S: Sequence>: Producer<S.Iterator.Element> {
