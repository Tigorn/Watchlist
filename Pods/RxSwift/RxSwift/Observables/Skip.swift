...
private final class SkipCountSink<O: ObserverType>: Sink<O>, ObserverType {
...
private final class SkipTimeSink<ElementType, O: ObserverType>: Sink<O>, ObserverType where O.E == ElementType {
