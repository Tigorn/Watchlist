...
private final class TimerSink<O: ObserverType>: Sink<O> where O.E: RxAbstractInteger {
...
private final class TimerOneOffSink<O: ObserverType>: Sink<O> where O.E: RxAbstractInteger {
    typealias Parent = Timer<O.E>
...
private final class Timer<E: RxAbstractInteger>: Producer<E> {
